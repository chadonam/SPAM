...
namespace SPAM.MainWork
{
    public partial class ucBLU : UserControl
    {
        ...
        private void SetFpSpread()
        {
            ...
            param1.Add(FpSpread.SetSheetColumns("TIMEKEY", "Timekey", FpSpread.FpCellType.Text, FontStyle.Regular, FpSpread.FpAlignment.Left, 120, Color.White, true, true, FpSpread.FpSort.False, 1, null));
            ...
            param2.Add(FpSpread.SetSheetColumns("TIMEKEY", "Timekey", FpSpread.FpCellType.Text, FontStyle.Regular, FpSpread.FpAlignment.Left, 120, Color.White, true, true, FpSpread.FpSort.False, 1, null));
