...
{
    public partial class ucBLU : UserControl
    {
        public ucBLU()
        {
            InitializeComponent();
        ...
        private void InitControl()
        {
            ...
            BaseDisplay.ChangeText(btnDel1);
            BaseDisplay.ChangeText(btnDelOK);
            BaseDisplay.ChangeText(btnDelNG);
        ...
        private void SetFpSpread()
        {
            ...
            param1.Add(FpSpread.SetSheetColumns("TIMEKEY", "Timekey", FpSpread.FpCellType.Text, FontStyle.Regular, FpSpread.FpAlignment.Left, 120, Color.White, false, true, FpSpread.FpSort.False, 1, null));
            ...
            param2.Add(FpSpread.SetSheetColumns("TIMEKEY", "Timekey", FpSpread.FpCellType.Text, FontStyle.Regular, FpSpread.FpAlignment.Left, 120, Color.White, false, true, FpSpread.FpSort.False, 1, null));
