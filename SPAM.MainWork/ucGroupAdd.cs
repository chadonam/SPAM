...
{
    public partial class ucGroupAdd : UserControl
    {
        public ucGroupAdd()
        {
            InitializeComponent();
        ...
        private void SetFpSpread()
        {
            ...
            param.Add(FpSpread.SetSheetColumns("그룹내부코드", "GroupSeq", FpSpread.FpCellType.Text, FontStyle.Regular, FpSpread.FpAlignment.Center, 120, Color.White, true, true, FpSpread.FpSort.False, 1, null));
            param.Add(FpSpread.SetSheetColumns("그룹명", "GroupName", FpSpread.FpCellType.Text, FontStyle.Regular, FpSpread.FpAlignment.Left, 250, Color.White, true, true, FpSpread.FpSort.False, 1, null));
        ...
        private void fpSpread1_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            txtGroupSeq.Text = fpSpread1.Sheets[0].Cells[e.Row, 0].Value.ToString();
            txtGroupName.Text = fpSpread1.Sheets[0].Cells[e.Row, 1].Value.ToString();
        ...
        private void Save(string WorkingTag)
        {
            ...
            try
            {
                ...
                groupSeq = txtGroupSeq.Text;
                groupName = txtGroupName.Text;
               

                using (CommonService svc = new CommonService())
                {
                    ds = svc.SetGroup(WorkingTag, groupSeq, groupName);
                }
        ...
        private void Search()
        {
            ...
            DataSet ds = null;
            string GroupName = txtGroupNameQ.Text;
