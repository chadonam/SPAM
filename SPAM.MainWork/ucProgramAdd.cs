...
namespace SPAM.MainWork
{
    public partial class ucProgramAdd : UserControl
    {
        ...
        private void SetFpSpread()
        {
            ...
            param.Add(FpSpread.SetSheetColumns("프로그램명", "PgmSeq", FpSpread.FpCellType.Password, FontStyle.Regular, FpSpread.FpAlignment.Center, 80, Color.White, true, true, FpSpread.FpSort.False, 1, null));
        ...
        private void Save(string WorkingTag)
        {
            ...
            try
            {
                ...
                userSeq = txtPgmSeq.Text;
                userID = txtPgmID.Text;
                password = txtPgmName.Text;
                groupSeq = "0";
